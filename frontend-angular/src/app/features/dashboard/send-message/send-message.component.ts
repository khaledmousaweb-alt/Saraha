...
export class SendMessageComponent {
  ...
  onSubmit(): void {
    ...
    this.isLoading = true;
    const { receiverId, content } = this.messageForm.value;

    this.messageService.sendMessage(content, receiverId, senderId).subscribe({
      next: () => {
  ...
  get receiverId() { return this.messageForm.get('receiverId'); }
